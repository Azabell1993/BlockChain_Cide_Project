    ...
    return __awaiter(this, void 0, void 0, function () {
        function addTransaction() {
            ...
            pendingTransactionsEl.textContent = blockchain.pendingTransactions.map(function (t) {
                return "".concat(t.sender, " \u2192 ").concat(t.recipient, ": $").concat(t.amount);
            }).join('\n');
